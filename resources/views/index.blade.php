                            ...
                            <div class="col-xl-9 col-md-9 col-md-12">
                                <div class="slider_text text-center">
                                    <h3>Fresh and Delicious Food
                                        For your Health</h3>
                                    <a href="menu.html" class="boxed-btn3">Book a Table</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about_info_wrap">
                            ...
                            <p>The best Myanmar traditional teashop in Myanmar. We serve a range of paos and puffs, as well as various traditional rice and noodle dishes. We strive to serve you the best traditional Myanmar tea.</p>
                            <ul class="food_list">
                                <li>
